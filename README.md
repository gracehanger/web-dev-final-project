...
**4. Use a media query to adjust the screen size**
* I used a media query in CSS to adjust the screen size on the Choose Your Character page that adjusts to 2 columns and 4 rows when the screen size is a mobile screen. Normally, it's 4 columns and 2 rows.

**5. Create a node.js web server using Express.js.**

**6. Create an API that implements HTTP requests for GET and POST. Data can be stored in a JSON file on the back-end.**

**7. Have at least two pages/routes:**
